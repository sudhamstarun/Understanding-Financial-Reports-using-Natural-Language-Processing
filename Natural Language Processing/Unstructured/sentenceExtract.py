...
def find(infile, outfile):
    with open(infile) as a, open(outfile, 'a') as b:
        for line in a:
            ...
            matches = re.finditer(r"( [^.]*?credit default swap([^\.]|\.(\d)|\.(\,))*\.| [^.]*?counterparty([^\.]|\.(\d)|\.(\,))*\.| [^.]*?receives([^\.]|\.(\d)|\.(\,))*\.| [^.]*?buy([^\.]|\.(\d)|\.(\,))*\.| [^.]*?sell([^\.]|\.(\d)|\.(\,))*\.|[^.]*?pays([^\.]|\.(\d)|\.(\,))*\.| [^.]*?\bpay\b([^\.]|\.(\d)|\.(\,))*\.|  [^.]*?reference entity([^\.]|\.(\d)|\.(\,))*\.| [^.]*?receive([^\.]|\.(\d)|\.(\,))*\.| [^.]*?expires([^\.]|\.(\d)|\.(\,))*\.|  [^.]*?fixed rate([^\.]|\.(\d)|\.(\,))*\.| [^.]*?quarterly([^\.]|\.(\d)|\.(\,))*\.|[^.]*?notional amount([^\.]|\.(\d)|\.(\,))*\.| [^.]*?due([^\.]|\.(\d)|\.(\,))*\. )", line, re.MULTILINE | re.IGNORECASE)
